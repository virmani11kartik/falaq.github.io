  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center px-6">
      <div className="text-center max-w-xl">
        <h1 className="font-display text-4xl text-charcoal mb-4">Work With Me</h1>
        <p className="text-warm-gray">
          Styling consultations are coming soon. For now, you can reach out via the contact page.
        </p>
        <Link
          href="/contact"
          className="inline-block mt-6 px-6 py-3 bg-charcoal text-cream rounded-full hover:bg-rose transition-all font-medium"
        >
          Contact
        </Link>
      </div>
